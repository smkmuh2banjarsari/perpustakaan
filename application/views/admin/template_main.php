...
<!--[if gt IE 8]><!
<html lang="id_ID" class="no-js" amp> <!--<![endif]
	<head>
		...
		<link rel="stylesheet" href="{base_url}assets/css/style.hiburan.custom.css" />
		
		<script src="{base_url}assets/js/modernizr.js">
		</script>
		<!--[if lt IE 9]>
		<script type="text/javascript" src="{base_url}assets/js/respond.min.js">
		</script>
		<![endif]
		[if lt IE 9]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]
		
		<script type="text/javascript" type="text/javascript" src="{base_url}assets/js/jquery-3.min.js">
		</script>
		<script type="text/javascript" src="{base_url}assets/js/jqueryui.min.js">
		</script>
		<script type="text/javascript" src="{base_url}assets/js/jquery.easing.1.3.js">
		</script>
		<script type="text/javascript" src="{base_url}assets/js/jquery.waypoints.min.js">
		</script>
		<script type="text/javascript" src="{base_url}assets/js/jquery.magnific-popup.min.js">
		</script>
		
		<script src="{base_url}assets/js/bootstrap.min.js">
		</script>
		
		<!--<script type="text/javascript" src="{base_url}assets/js/saveba.js">
		</script>
		...
		<script type="text/javascript">
			...
			$jq(document).ready(
				function(){
					...
					$jq("#keAtas").click(function(event) {
			...
			function form_validate(form){
				if(form.username.value==''){ alert('Username tidak boleh kosong'); form.username.focus(); return false; }
				if(form.password.value==''){ alert('Password tidak boleh kosong'); form.password.focus(); return false; }
				return true;
			}
			
			function validasi_nama(form){
				if(form.nama.value==''){ alert('Nama tidak boleh kosong'); form.nama.focus(); return false; }
				return true;
			}
		</script>
		<script type="text/javascript" src="{base_url}assets/js/hiburan.main.js">
		</script>
