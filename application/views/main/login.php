...
require_once APPPATH."views/main/template_parse_login_admin.php";


/* End of file login.php */
/* Location: ./application/views/korporasi/login.php */
