...
$map_dir = "<a href='$main_url'>Home</a> &#187; Berita ";

include_once (APPPATH."libraries/Rssparser.php");

//$this->load->library('rssparser');							// load library
$rss = new Rssparser();
$rss->set_feed_url('https://blog.smkm2banjarsari.sch.id/feeds/posts/default/?alt=rss'); //('http://feeds.feedburner.com/smkm2banjarsari'); 	// get feed
